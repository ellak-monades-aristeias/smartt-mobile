...
public class GPSTracker extends Service implements LocationListener {
    ...
    public String isGpsFix = "no";
    boolean GPSfixed = false;
    Location location; // location
    double latitude; // latitude
    double longitude; // longitude

    double mLastLocationMillis;
    ...
    private static final long MIN_TIME_BW_UPDATES = 1000 * 5 * 1; // 10 seconds
            ...
            switch (event) {
                case GpsStatus.GPS_EVENT_SATELLITE_STATUS:
                    if (mLastLocation != null)
                        GPSfixed = (SystemClock.elapsedRealtime() - mLastLocationMillis) < 30000;
